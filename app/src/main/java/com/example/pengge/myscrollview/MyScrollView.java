...
public class MyScrollView extends ScrollView {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(i == 0) {
            ...
            Log.e("initMarginBottom",String.valueOf(initMarginBottom)+ "!!!!!!!!");
        }
        i = i + 1;
        //加载下拉刷新界面
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        Log.e("onInterceptTouchEvent",String.valueOf(event.getAction()));
    ...
    private boolean moveAction(MotionEvent event) {
        ...
        if(yMove > yDown) {
            ...
            if (currentFreshStatus != STATUS_REFRESHING) {
                ...
                scrollViewLayoutParams.topMargin = (initMarginTop + (distance/4));
                this.setLayoutParams(scrollViewLayoutParams);
            }
        }else {
            ...
            if (currentLoadStatus != STATUS_RELOADING) {
                Log.e("initMarginBottom",String.valueOf(initMarginBottom));
                Log.e("bottomMargin",String.valueOf(scrollViewLayoutParams.bottomMargin));
                ...
                scrollViewLayoutParams.bottomMargin = (initMarginBottom + (distance/4));
                this.setLayoutParams(scrollViewLayoutParams);
            }
        }
        return true;
